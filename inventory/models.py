...
class Product(models.Model):
    ...
    category = models.CharField(max_length=20, choices=Category, default=Category.EMPTY_OPTION)
    type_variant = models.CharField(max_length=20, choices=TypeVariant, default=TypeVariant.EMPTY_OPTION)
    description = models.TextField(default='', blank=True)
    base_product = models.ForeignKey('self', on_delete=models.SET_NULL, null=True, blank=True, related_name='variants')
