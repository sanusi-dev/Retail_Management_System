...
from .models import Brand, Product, Inventory, SerializedInventory, InventoryTransformation
...
class ProductAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ('sku', 'brand', 'modelname', 'category', 'type_variant', 'base_product')
    list_filter = ('brand', 'category', 'type_variant')
...
class SerializedInventoryAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ('product', 'engine_number', 'chassis_number', 'status', 'received_date')
    list_filter = ('status',)
...
class InventoryTransformationAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ('transformation_id', 'boxed_product', 'coupled_product', 'engine_number', 'chassis_number', 'transformation_date')
